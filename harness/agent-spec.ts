 ...
 * with stub tools. Real recording/TTS/recipes/Bright Data are later phases.
 */
export const agentSpec: TrueForgeApi.AgentSpec = {
  ...
  instructions:
    "You are Nolan, an AI product-marketing agent. When asked to make a demo or launch " +
    "post, call record_demo to capture the feature, then draft the post copy yourself, then " +
    "call publish_post with the drafted copy once you have something ready to ship. " +
    "publish_post requires human approval — always wait for it.",
  mcpServers: [
    {
